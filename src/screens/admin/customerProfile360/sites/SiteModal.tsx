...
import type { SiteModalProps } from "../../../../types/interfaces";
      ...
      footer={
        <>
          ...
          <Button
            ...
            onClick={() => void onSave()}
            disabled={submitting}
            className="flex-2 rounded-lg border-blue-600 bg-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-800 disabled:opacity-50"
          >
        ...
        {!isEdit ? (
          <div className="space-y-3">
            ...
            <Button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-slate-300 bg-white px-4 py-2 text-xs font-semibold text-slate-600 shadow-none transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-40"
            >
              + Agregar adjunto
            </Button>
            <input
